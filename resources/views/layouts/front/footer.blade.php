    ...
    <div class="container-fluid bg-dark footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
      ...
      <!-- Back to Top -->
      <a href="#" class="btn btn-lg btn-primary btn-lg-square back-to-top"><i class="fas fa-long-arrow-alt-up fa-lg"></i></a>
  
      <!-- JavaScript Libraries -->
      <script src="{{asset('front')}}/asset/js/jquery-3.4.1.min.js"></script>
      ...
      <script src="{{asset('front')}}/asset/js/fontawesome.min.js"></script>
